...
names_file = os.path.join(args.save_dir, args.dataset_name,
                          args.query_strategy + '_names_' + str(args.labeled_ratio) + '_' + str(args.alpha) + '_' + str(
                              args.beta) + '.npy')
probs_file = os.path.join(args.save_dir, args.dataset_name,
                          args.query_strategy + '_probs_' + str(args.labeled_ratio) + '_' + str(args.alpha) + '_' + str(
                              args.beta) + '.npy')
print("Test5")
